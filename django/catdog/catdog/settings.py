...
SECRET_KEY = 'django-insecure-nxut&15m2she379ap6r+2j=_2$gy4bc+!vvgg*4irh)votq=#2'
...
# Extra directories (optional, if you store static files in your app folders)
STATICFILES_DIRS = [
